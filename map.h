...
#define UNLOCKED 1
// for NPC
#define BEFORE_QUEST 0
#define Q_STEP1     1
#define Q_MONSTER_DIED 2
#define AFTER_QUEST 3
// for monster
#define DIE 0
#define ALIVE 1
// for spell
...
void add_stair(int x, int y);
void add_door(int x, int y);
void add_mst(int x, int y);
void add_spell_f(int x, int y);
void add_spell_w(int x, int y);
void add_spell_wind(int x, int y);
